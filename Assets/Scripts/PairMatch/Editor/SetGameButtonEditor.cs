    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (myScript.ButtonType)
        {
            case SetGameButton.EButtonType.PairNumberBtn:
                myScript.PairNumber = 
                    (GameSettings.EPairNumber) EditorGUILayout.EnumPopup(label: "Pair Numbers", myScript.PairNumber);
                break;
            case SetGameButton.EButtonType.PuzzleCategoryBtn:
                myScript.PiuzzlCategories = 
                    (GameSettings.EPuzzleCategories) EditorGUILayout.EnumPopup(label: "Puzzle Categories", myScript.PiuzzlCategories);
                break;
        }
