...
public class PictureManager : MonoBehaviour
{
    ...
    private Vector2 _offset = new Vector2(1.7f, 1.8f);
    private Vector2 _offsetFor15Pairs = new Vector2(2f, 2f);
    private Vector2 _offsetFor20Pairs = new Vector2(1.7f, 2f);
