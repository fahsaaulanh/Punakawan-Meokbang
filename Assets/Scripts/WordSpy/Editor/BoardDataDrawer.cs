...
public class BoardDataDrawer : Editor
{
    ...
    {
        InitializeReoardableList(ref _dataList, "SearchWords", "Searching Words");
    }
    ...
    private void InitializeReoardableList(ref ReorderableList list, string propertyName, string listLabel)
    {
